...
class mod_articles_categoryTraditionalGhsvsInstallerScript extends InstallerScript
{
	/**
	...
	protected $deleteFolders = [
		'/modules/mod_articles_categorytraditionalghsvs/copy2media',
		'/modules/mod_articles_categorytraditionalghsvs/media2copy',
		'/media/mod_articles_categorytraditionalghsvs',
	];
